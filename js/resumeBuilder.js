...
var work = {
	"jobs": [
	{
		...
		"description": "Took part in a big data analysis project for Huaxia Bank," +
		" a public traded bank in China. The responsibility includes some front-end" +
		" like using ProcessingJS to display data, and some back-end like debugging" +
		" back-end frameworks, Morphia, Spring."
	},
	{
...
var projects = {
	"projects": [
	{
		...
		"description": "Provided a design mockup as a PDF-file, I am required to" +
		" replicate the design as closely as possible in HTML and CSS. And I am" +
		" also required to develop a responsive website for a single product" +
		" overview page by using the popular Twitter's Bootstrap framework.",
		"images": ["images/ss1-1.jpg", "images/ss2-1.jpg"],
		"images_enlarge": ["images/ss1-1_enlarge.jpg", "images/ss2-1_enlarge.jpg"]
	},
	{
		"title": "Design project for Human-Computer Interaction",
		"dates": "September.2014 - December.2014",
		"description": "This project is about plan and design a alarm, stopwatch" +
		" and timer application, implement, evaluate with users. The project is" +
		" divided into three projectmilestones. Milestone#1 is Proposal & Software" +
		" Survey, Milestone#2 is Design & First Prototype, Milestone#3 is Evaluate," +
		" Refine & Final Prototype.",
		"images": [
		"images/ss2-2.jpg",
		"images/ss3-2.jpg",
		"images/ss4-2.jpg",
